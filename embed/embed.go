...
// composes the shell plane through this; `soulstream-shell serve` is the seam's
...
import (
	...
	"github.com/impire-io/soulstream-shell/internal/shellserver"
)

// Options mirrors shellserver.Options — the deployment supplies every
// surface the shell consumes; the shell founds and owns nothing.
type Options struct {
...
func Run(ctx context.Context, o Options) error {
	return shellserver.Run(ctx, shellserver.Options{
